...
Запуск скрипта:
```
wget https://raw.githubusercontent.com/kkkkkCampbell/master/refs/heads/main/openwrt_full_backup.sh -O /backup && \
...
```
sh <(wget -qO- https://raw.githubusercontent.com/kkkkkCampbell/master/refs/heads/main/user_installed_packages.sh)
```
